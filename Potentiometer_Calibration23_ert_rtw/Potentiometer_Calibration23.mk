###########################################################################
## Makefile generated for component 'Potentiometer_Calibration23'. 
## 
## Makefile     : Potentiometer_Calibration23.mk
## Generated on : Mon Jul 07 15:25:22 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Potentiometer_Calibration23.elf
...
PRODUCT_NAME              = Potentiometer_Calibration23
MAKEFILE                  = Potentiometer_Calibration23.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Potentiometer_Calibration23.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -I$(START_DIR)/Potentiometer_Calibration23_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2023b/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
%.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Potentiometer_Calibration23.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/Potentiometer_Calibration23.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Potentiometer_Calibration23_data.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/Potentiometer_Calibration23_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Potentiometer_Calibration23_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
