...
#define MW_CONNECTIONINFO_XCPONTCPIP_IPADDRESS codertarget.raspi.getExtModeDeviceAddress
...
#define MW_CONNECTIONINFO_TCPIP_IPADDRESS codertarget.raspi.getExtModeDeviceAddress
