###########################################################################
## Makefile generated for component 'PendulumQuickStart'. 
## 
## Makefile     : PendulumQuickStart.mk
## Generated on : Tue Mar 31 16:52:36 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PendulumQuickStart.elf
...
PRODUCT_NAME              = PendulumQuickStart
MAKEFILE                  = PendulumQuickStart.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PendulumQuickStart.elf
...
%.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/PendulumQuickStart_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/PendulumQuickStart_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendulumQuickStart.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/PendulumQuickStart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendulumQuickStart_data.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/PendulumQuickStart_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/PendulumQuickStart_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
