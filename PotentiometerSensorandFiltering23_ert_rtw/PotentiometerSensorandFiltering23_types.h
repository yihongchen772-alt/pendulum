 ...
 *
 * File: PotentiometerSensorandFiltering23_types.h
 *
...
#ifndef RTW_HEADER_PotentiometerSensorandFiltering23_types_h_
#define RTW_HEADER_PotentiometerSensorandFiltering23_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"

/* Custom Type definition for MATLABSystem: '<S2>/Serial Read' */
#include "MW_SVD.h"
...
typedef struct tag_VOf4ufvAb7nufAMTC2gUxC codertarget_raspi_internal__o_T;
...
typedef struct P_PotentiometerSensorandFilte_T_ P_PotentiometerSensorandFilte_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_PotentiometerSensoran_T RT_MODEL_PotentiometerSensora_T;

#endif               /* RTW_HEADER_PotentiometerSensorandFiltering23_types_h_ */
